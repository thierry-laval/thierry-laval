TODO <!--voir pour la mise en page des tiroirs-->
...
Créer un tableau en html/css

<style type="text/css">
.tg td{border-color:orange;border-style:solid;border-width:0px;font-family:system-ui;font-size:14px;overflow:hidden;padding:10px;word-break:normal; text-align:left;vertical-align:top;}
</style>
<table class="tg">
<tr>
<td><div>
